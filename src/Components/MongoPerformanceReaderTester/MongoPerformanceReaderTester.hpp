...
#ifndef  MongoPerformanceReaderTester_H__
#define  MongoPerformanceReaderTester_H__
...
class MongoPerformanceReaderTester: public Base::Component
{
public:
        /*!
         * Constructor.
         */
		MongoPerformanceReaderTester(const std::string & name = "");

        /*!
         * Destructor
         */
        virtual ~MongoPerformanceReaderTester();
...
protected:
        ...
        /// Event handler.
        Base::EventHandler <MongoPerformanceReaderTester> h_readfromDB;
private:
...
REGISTER_COMPONENT("MongoPerformanceReaderTester", Processors::MongoPerformanceReaderTester::MongoPerformanceReaderTester)

#endif /* MongoPerformanceReaderTester_H__ */
